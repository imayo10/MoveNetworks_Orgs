...
header = ['Free', 'NetworkID', 'Name', 'Tag1', 'Tag2', 'Tag3', 'Tag4', 'Direccion', 'Serial1', 'Serial2', 'Serial3', 'Nombre', 'VLAN10', 'SVI10', 'VLAN20', 'SVI20', 'VLAN30', 'SVI30', 'VLAN40', 'SVI40']
...
while count < num_networks:
    ...
    if num_devices == 3:
        ...
        name = tag1 + '-' + tag2
        data = ['', network_id, network_name, tag1, tag2, tag3, tag4, address, serial1, serial2, serial3, name, subnet10, svi10, subnet20, svi20, subnet30, svi30, subnet40, svi40]
